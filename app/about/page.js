  ...
  return (
    ...
    <div style={{width:'100%',height:'100vh',display:'flex',alignItems:'center',justifyContent:'space-between'}} id="main">
        <div style={{width:'48%',height:'100%'}} className="section">
           <h1 style={{paddingTop:'220px',paddingLeft:'100px',fontSize:'3rem'}}>Photos for everyone</h1>
        ...
        <div style={{width:'48%',height:'100%',overflow:'hidden'}} className="section">
            <img style={{height:'100%',width:'100%',objectFit:'cover',padding:'50px 50px'}} src="https://unsplash-assets.imgix.net/marketing/about-header-01.jpg" alt="" />
        </div>
    </div>
